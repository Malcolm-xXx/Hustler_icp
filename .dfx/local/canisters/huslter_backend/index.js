...
import { idlFactory } from './huslter_backend.did.js';
export { idlFactory } from './huslter_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HUSLTER_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./huslter_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the huslter_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./huslter_backend.did.js")._SERVICE>}
 */
export const huslter_backend = createActor(canisterId);
